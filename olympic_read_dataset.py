...
olympic_data_1.rename(columns= {'Event' : 'complete_event'}, inplace= True)
#print(olympic_data_1)
# print(olympic_data_1.head(5))
olympic_athletes_2 =  pd.read_csv("./data/olympic_data_2020/athletes.csv")
# print(olympic_athletes_2)
...
olympic_athletes_2.rename(columns={'name': 'Name', 'discipline': 'complete_event', 'country' : "Team"}, inplace=True)
...
medals_columns = ["athlete_name", "athlete_sex", "year", "country", "complete_event", "medal"]
total_medals_columns = ["Country", "Year", "Gold Medal", "Silver Medal", "Bronze Medal","Total"]
...
olympic_athletes_3.rename(columns={'name': 'Name', 'country' : "Team", 'height' : 'Height'}, inplace=True)
...
olympic_medals_subset = olympic_data_1[["Name","Sex","Year","Team","complete_event","Medal"]] 
olympic_medals = olympic_medals_subset.dropna(subset="Medal")

olympic_medals.rename(columns={'Name': 'athlete_name', 'Sex' : 'athlete_sex', 'Team' : 'country', 'Year' :'year', 'Medal': 'medal'}, inplace=True)
...
total_medals = olympic_medals_unique.loc[:, ["country", "year", "medal"]]

# Display the updated DataFrame
# print(total_medals.head())

# Create a pivot table to count each medal type for each country
medal_count = total_medals.pivot_table(index=['country', 'year'], columns='medal', aggfunc='size', fill_value=0)
# print(medal_count)
...
desired_column_order = ["country", "year", "Gold Medal", "Silver Medal", "Bronze Medal", "Total_Medals"]
